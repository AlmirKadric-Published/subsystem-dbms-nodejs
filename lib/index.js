...
//
exports.registerConnectorType = (typeName, module) => connectors.registerConnectorType(typeName, module);
...
exports.registerMigrate = (dbName, version, module, meta) => migrate.registerMigrate(dbName, version, module, meta);
